#' Plot a Bottleneck Style Reingold-Tilford tree diagram
#' @description A bottleneck style Reingold-Tilford tree diagram is one where a given set of parent and child relationship levels are plotted where they converge on the single input concept_id in the center. This differs from an "umbrella" style Reingold-Tilford tree diagram where the topmost parent is derived and all the children from that point onwards are returned.
#' @import purrr
...
#' Plot an Umbrella Style Reingold-Tilford tree diagram
#' @description An "umbrella" style Reingold-Tilford tree diagram where the topmost parent is derived and all the children from that point onwards are returned. See `plotBottleneck` to learn more about the Bottleneck-style diagram.
#' @import purrr
#' @import collapsibleTree
#' @import tibble
#' @import dplyr
