...
#' @description
#' The Drug Strength Processed Table is joined to the provided drug_concept_ids and the
...
FROM crosstab('SELECT
    ...
    if (include_rates) {
      ...
      target_concepts3 <-
        ...
        dplyr::mutate(
          denominator_value = ifelse(!is.na(rate_concept_name), NA_character_, native_denominator_value),
        ...
        dplyr::rename(
          native_staged_value = staged_value,
