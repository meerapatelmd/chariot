...
#' @seealso
#'  \code{\link[SqlRender]{render}}
#' @rdname queryPhraseExactSynonym
#' @export
#' @family query functions
#' @importFrom SqlRender render
...
#' @rdname queryPhraseStringSynonym
#' @export
#' @family query functions
#' @importFrom pg13 buildQueryString
